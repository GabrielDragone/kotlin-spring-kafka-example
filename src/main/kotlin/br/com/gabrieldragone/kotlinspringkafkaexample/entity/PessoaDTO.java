 ...
 */
package br.com.gabrieldragone.kotlinspringkafkaexample.entity;
...
public class PessoaDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6300479720201104389L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PessoaDTO\",\"namespace\":\"br.com.gabrieldragone.kotlinspringkafkaexample.entity\",\"fields\":[{\"name\":\"nome\",\"type\":\"string\"},{\"name\":\"sobrenome\",\"type\":\"string\"}]}");
   ...
   */
  public static br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder newBuilder() {
    return new br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder();
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder newBuilder(br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder other) {
    return new br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder(other);
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder newBuilder(br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO other) {
    return new br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PessoaDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.nome)) {
        this.nome = data().deepCopy(fields()[0].schema(), other.nome);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder setNome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder clearNome() {
      nome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder setSobrenome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.com.gabrieldragone.kotlinspringkafkaexample.entity.PessoaDTO.Builder clearSobrenome() {
      sobrenome = null;
